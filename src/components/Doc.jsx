    ...
    return (
        <Dock className="z-10 bg-gray-900 t-20 mb-10 fixed bottom-0 left-1/2 transform -translate-x-1/2 px-4 py-2 rounded-lg">
            ...
            <DockIcon title="LinkedIn">
                <a href="https://www.linkedin.com/in/alex-houle-53a4b9328/" target="_blank" rel="noopener noreferrer">
                    <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="currentColor" viewBox="0 0 24 24">
                        <path fillRule="evenodd"
            ...
            <DockIcon title="Email">
                <a href="mailto:alexhoule415@gmail.com" target="_blank" rel="noopener noreferrer">
                    <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                        xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                        fill="currentColor" viewBox="0 0 24 24">
